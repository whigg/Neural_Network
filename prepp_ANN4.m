%function prepp_ANN
% Moho
I1=GEOTIFF_READ('E:\STORAGE_COEFF\SCC_Grace\matlab_in\moho_dep_4km_Clip13.tif');
...
%Kriged_surface
I2=GEOTIFF_READ('E:\STORAGE_COEFF\SCC_Grace\matlab_in\GALayerToGri2_ProjectRaster_41.tif');
...
%Permeability
I3=GEOTIFF_READ('E:\STORAGE_COEFF\SCC_Grace\matlab_in\perm_fas2_PolygonToRaster2_P1.tif');
%info3=geotiffinfo('E:\STORAGE_COEFF\SCC_Grace\matlab_in\perm_fas2_PolygonToRaster2_P1.tif');
[x3, y3]=meshgrid(I3.x, I3.y);
%Soil type
I4=GEOTIFF_READ('E:\STORAGE_COEFF\SCC_Grace\matlab_in\soil_clip1.tif');
%info4=geotiffinfo('E:\STORAGE_COEFF\SCC_Grace\matlab_in\soil_clip1.tif'); 
[x4, y4]=meshgrid(I4.x, I4.y);
%DEM-SLOPE
I5=GEOTIFF_READ('E:\STORAGE_COEFF\SCC_Grace\matlab_in\Slope_mosaic1_Clip1.tif');
%info5=geotiffinfo('E:\STORAGE_COEFF\SCC_Grace\matlab_in\Slope_mosaic1_Clip1.tif'); 
[x5,y5]=meshgrid(I5.x, I5.y);
%GRACE_solutions
I=GEOTIFF_READ('E:\STORAGE_COEFF\SCC_Grace\matlab_in\SC_compp5_PointToRaster_Clip711.tif');
